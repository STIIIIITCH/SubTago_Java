...
public class line9Activity extends AppCompatActivity {
    ...
    TextView textLine9Result, textStation9Result, textLocation9Result;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //xml객체 연결
        textLine9Result = findViewById(R.id.textLine9Result);
        textStation9Result = findViewById(R.id.textStation9Result);
        textLocation9Result = findViewById(R.id.textLocation9Result);
        ...
        Cursor cursor;
        cursor = sqlDB2.rawQuery("SELECT * FROM WheelChairTBL WHERE lineName = '9호선'", null);
        ...
        //출력해주기
        textLine9Result.setText(strLines);
        textStation9Result.setText(strStations);
        textLocation9Result.setText(strLocations);
